...
(5, '2020_06_19_150225_create_boards_table', 1),
(6, '2020_06_19_150350_create_tasks_table', 1),
(7, '2022_07_11_112759_create_projects_table', 1);
...
CREATE TABLE `projects` (
  ...
  `project_template` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tasks` (
  ...
  `privacy_status` tinyint(4) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
