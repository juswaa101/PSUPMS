                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="project_start_date"
                                                id="start_date" placeholder="Project Title"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="project_end_date"
                                                id="due_date" placeholder="Project Title"
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="mt-1">
                                                <select class="form-control w-100" name="staff[]" id="members"
                                                    multiple required>
